              ...
              <SheetContent side="right" className="w-[280px]">
                <div className="flex flex-col gap-4 mt-6">
                  <Link to="/" className="flex items-center gap-2 mb-4" onClick={() => setMobileMenuOpen(false)}>
                    ...
                    <span className="font-bold text-foreground">Vogatchi CRM</span>
                  </Link>
      ...
      <footer className="py-8 sm:py-12 border-t border-border bg-muted/30">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <p className="text-xs sm:text-sm text-muted-foreground">© {new Date().getFullYear()} Vogatchi CRM. جميع الحقوق محفوظة.</p>
          </div>
        </div>
      </footer>
    </div>
