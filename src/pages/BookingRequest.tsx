        ...
        <div className="grid md:grid-cols-4 gap-4 mb-8">
          <Card className="text-center hover:shadow-lg transition-shadow">
            <CardContent className="p-4">
              ...
              <p className="text-sm text-gray-600">أفضل الأسعار</p>
            </CardContent>
          </Card>
          ...
          <Card className="text-center hover:shadow-lg transition-shadow">
            <CardContent className="p-4">
              ...
              <p className="text-sm text-gray-600">رحلات مريحة</p>
            </CardContent>
          </Card>
          ...
          <Card className="text-center hover:shadow-lg transition-shadow">
            <CardContent className="p-4">
              ...
              <p className="text-sm text-gray-600">أحدث الموديلات</p>
            </CardContent>
          </Card>
          ...
          <Card className="text-center hover:shadow-lg transition-shadow">
            <CardContent className="p-4">
              ...
              <p className="text-sm text-gray-600">عروض مميزة</p>
            </CardContent>
          </Card>
        </div>
