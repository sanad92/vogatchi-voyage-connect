...
interface SmartSegmentGridProps {
  customers: any[] | undefined;
}

const SmartSegmentGrid = ({ customers }: SmartSegmentGridProps) => {
  ...
  const calculateSegmentPredictions = (segment: SmartSegment) => {
    ...
    return {
      potentialRevenue: avgOrderValue * segmentCustomers.length * 1.2,
...
export default SmartSegmentGrid;
