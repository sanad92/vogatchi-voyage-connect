...
import { User, Users, FileText, Whatsapp, Invoice } from "lucide-react";
...
const menu = [
  ...
  { name: "الفواتير", route: "/invoices", icon: <Invoice size={18} /> },
  { name: "محادثات الواتساب", route: "/whatsapp", icon: <Whatsapp size={18} color="#25d366" /> },
