...
CREATE INDEX idx_whatsapp_conversations_assigned_to ON whatsapp_conversations(assigned_to);
...
CREATE INDEX idx_whatsapp_sessions_employee_id ON whatsapp_sessions(employee_id);
CREATE INDEX idx_whatsapp_analytics_date ON whatsapp_analytics(date);
