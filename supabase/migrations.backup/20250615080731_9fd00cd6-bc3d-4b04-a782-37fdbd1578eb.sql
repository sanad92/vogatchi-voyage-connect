...
ADD COLUMN payment_type TEXT DEFAULT 'deferred' CHECK (payment_type IN ('prepaid', 'deferred')),
ADD COLUMN payment_method_options JSONB DEFAULT '["bank_transfer"]'::jsonb;
...
CREATE INDEX idx_suppliers_payment_type ON public.suppliers(payment_type);
