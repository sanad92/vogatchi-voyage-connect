...
SET 
  ...
  seo_description = 'اكتشف العالم مع فوجاتشي للتسويق السياحي. نقدم أفضل العروض للفنادق، الطيران، تأجير السيارات والرحلات السياحية بأسعار منافسة.',
  seo_keywords = ARRAY['فوجاتشي', 'سياحة', 'سفر', 'حجز فنادق', 'حجز طيران', 'رحلات سياحية', 'تأجير سيارات', 'عروض سفر'],
  updated_at = now()
WHERE slug = 'home';
...
INSERT INTO public.blocks (page_id, block_type, content, layout_settings, order_index, is_active)
VALUES (
  (SELECT id FROM public.pages WHERE slug = 'home'),
  'hero',
  '{
    "title": "مرحباً بك في فوجاتشي للتسويق السياحي",
