-- Add new block types for general pages
ALTER TYPE public.block_type_enum ADD VALUE IF NOT EXISTS 'auth_form';
ALTER TYPE public.block_type_enum ADD VALUE IF NOT EXISTS 'booking_form';
ALTER TYPE public.block_type_enum ADD VALUE IF NOT EXISTS 'page_header';
ALTER TYPE public.block_type_enum ADD VALUE IF NOT EXISTS 'text_content';
ALTER TYPE public.block_type_enum ADD VALUE IF NOT EXISTS 'feature_list';
ALTER TYPE public.block_type_enum ADD VALUE IF NOT EXISTS 'pricing_table';
