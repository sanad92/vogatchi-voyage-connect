...
ADD COLUMN service_category TEXT DEFAULT 'other' CHECK (service_category IN ('hotel', 'flight', 'transfer', 'car_rental', 'local_tour', 'other'));
...
ADD COLUMN vat_rate DECIMAL(5,2) DEFAULT 14.00,
ADD COLUMN vat_amount DECIMAL(10,2) GENERATED ALWAYS AS (subtotal * vat_rate / 100) STORED;
