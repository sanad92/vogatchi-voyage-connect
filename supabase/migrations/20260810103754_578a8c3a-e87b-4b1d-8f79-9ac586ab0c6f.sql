...
REVOKE EXECUTE ON FUNCTION public.sop_set_department(uuid, sop_department, boolean, text) FROM anon, public;
REVOKE EXECUTE ON FUNCTION public.sop_set_availability(uuid, boolean, text) FROM anon, public;
GRANT EXECUTE ON FUNCTION public.sop_set_department(uuid, sop_department, boolean, text) TO authenticated;
